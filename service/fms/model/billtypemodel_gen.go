...
var (
	...
	billTypeRowsExpectAutoSet   = strings.Join(stringx.Remove(billTypeFieldNames), ",")
	billTypeRowsWithPlaceHolder = builder.PostgreSqlJoin(stringx.Remove(billTypeFieldNames, "id"))
)
